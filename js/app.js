(() => {
    ...
    function dropInit() {
        let links = document.querySelectorAll(".menu__link_sub");
        if (links) document.addEventListener("click", (function(e) {
            links.forEach((link => {
                if (e.target == link) link.parentElement.classList.toggle("active"); else link.parentElement.classList.remove("active");
            }));
        }));
    }
    function menuInit() {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".realestate__slider")) new core(".realestate__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            autoHeight: true,
            speed: 800,
            pagination: {
                el: ".realestate__slider .swiper-pagination",
                clickable: true
            },
            breakpoints: {
                320: {
